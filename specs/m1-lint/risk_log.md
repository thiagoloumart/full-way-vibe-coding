...
**Última atualização:** 2026-04-18 (início de F3)
**Status:** Em andamento
...
- **Mitigação:** Registrar cada drift descoberto como novo R-NNN. Remediar antes de fechar F3 (mesma regra do fim de F2).
- **Critério de invalidação:** fim de F3 sem encontrar nada seria suspeito — aumenta confiança, mas também suspeita de que smoke está insuficiente.
- **Watcher:** smoke pós-F3, ativo agora.
